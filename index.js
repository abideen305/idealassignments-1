...
const connectDatabase = require("./src/db/mongoose");

const startServer = (databaseConnection) => {
  ...
  app.use(
    session({
      ...
      store: new MongoStore({
        ...
        mongooseConnection: databaseConnection, // tell your store to use your db defined in your database file to store your session;
      }),
    })
  );
